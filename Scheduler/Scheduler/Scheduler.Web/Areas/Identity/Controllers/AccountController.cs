...
using Scheduler.Infrastructure.Common.Audit.Services;
using Scheduler.Infrastructure.Common.Email.Models.EmailViewModels;
using Scheduler.Infrastructure.Common.Email.Services;
using Scheduler.Infrastructure.Identity.Extensions;
